...
public class addFavouritesActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        chooseImageButton = (Button) findViewById(R.id.addImageButtonF);
        uploadListingButton = (Button) findViewById(R.id.uploadListingButtonF);
        booknameText = (EditText) findViewById(R.id.booknameViewF);
        authorText = (EditText) findViewById(R.id.authorViewF);
        previewView = (ImageView) findViewById(R.id.previewViewF);
    ...
    private boolean uploadFile() {
        ...
        if(uri != null) {
            ...
            final StorageReference ref  = mStorage.getReference("favourites").child(booknameText.getText().toString().trim() + "-" + user.getUID() +"."+ getExtension(uri));
